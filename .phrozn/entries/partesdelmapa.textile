...
Miremos en detalle lo que hace el script de inicialización. La primera línea del script usa la técnica jQuery para asegurarse de que la siguiente línea sea ejecutada cuando el documento ya esté cargado.
